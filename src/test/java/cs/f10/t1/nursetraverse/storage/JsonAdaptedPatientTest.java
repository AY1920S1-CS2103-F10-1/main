...
public class JsonAdaptedPatientTest {
    ...
    private static final List<JsonAdaptedMedicalCondition> VALID_MED_CONS = BENSON.getMedicalConditions().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPatient patient =
                new JsonAdaptedPatient(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_MED_CONS, VALID_VISIT_TODOS, VALID_VISITS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPatient patient = new JsonAdaptedPatient(VALID_NAME, VALID_PHONE,
                null, VALID_ADDRESS, VALID_MED_CONS, VALID_VISIT_TODOS, VALID_VISITS);
        String expectedMessage = String.format(JsonAdaptedPatient.MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPatient patient =
                new JsonAdaptedPatient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_ADDRESS, VALID_MED_CONS, VALID_VISIT_TODOS, VALID_VISITS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPatient patient = new JsonAdaptedPatient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_MED_CONS, VALID_VISIT_TODOS, VALID_VISITS);
        String expectedMessage = String.format(JsonAdaptedPatient.MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidMedicalConditions_throwsIllegalValueException() {
        List<JsonAdaptedMedicalCondition> invalidMedicalConditions = new ArrayList<>(VALID_MED_CONS);
        invalidMedicalConditions.add(new JsonAdaptedMedicalCondition(INVALID_MED_CON));
        JsonAdaptedPatient patient =
                new JsonAdaptedPatient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, invalidMedicalConditions, VALID_VISIT_TODOS, VALID_VISITS);
    ...
    public void toModelType_invalidVisitTodo_throwsIllegalValueException() {
        ...
        JsonAdaptedPatient patient =
                new JsonAdaptedPatient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_MED_CONS, invalidTodo, VALID_VISITS);
        assertThrows(IllegalValueException.class, patient::toModelType);
    }
}
