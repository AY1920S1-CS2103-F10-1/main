...
import static cs.f10.t1.nursetraverse.logic.commands.CommandTestUtil.VALID_MED_CON_FRIEND;
...
public class TypicalPatients {
    ...
    public static final Patient ALICE = new PatientBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253")
            .withMedicalConditions("friends").withPreviousVisits().build();
    public static final Patient BENSON = new PatientBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432")
            .withMedicalConditions("owesMoney", "friends").withOngoingVisit().build();
    ...
    public static final Patient DANIEL = new PatientBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withMedicalConditions("friends").build();
    ...
    public static final Patient AMY = new PatientBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withMedicalConditions(VALID_MED_CON_FRIEND)
