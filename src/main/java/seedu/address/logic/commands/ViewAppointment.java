...
public class ViewAppointment extends ViewCommand {
    ...
    public ViewAppointment(Index targetIndex) {
        super(targetIndex);
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof ViewAppointment // instanceof handles nulls
                && targetIndex.equals(((ViewAppointment) other).targetIndex)); // state check
    }
}
